...
struct PointType
{
	...
	PointType* next1;  // Next point on the path
	PointType* next2;
	PointType* next3;
...
//Function Prototypes
void StepFrom(/*inout*/PointType &p, /*in*/MazeType &maze, int /*out*/&status);
...
void StepFrom(PointType &p, MazeType &maze, int &status)
